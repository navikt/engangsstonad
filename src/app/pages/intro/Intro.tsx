...
const Intro: React.FunctionComponent<Props> = ({ søkerinfo, godkjentVilkår, language, dispatch, history }) => {
    const intl = useIntl();
    ...
    return (
        <div id="js-intro">
            <DocumentTitle title={getMessage(intl, 'intro.standard.dokumenttittel')} />
