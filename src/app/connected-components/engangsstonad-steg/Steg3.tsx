...
const Steg3: React.FunctionComponent<Props> = ({ dispatch, informasjonOmUtenlandsopphold, språkkode }) => {
    ...
    /*
        useEffect(() => {
            overlapsWithOtherUtenlandsopphold = overlapsWithOtherUtenlandsopphold.bind(this);
            validateFomDatoSiste12Mnd = validateFomDatoSiste12Mnd.bind(this);
            validateTomDatoSiste12Mnd = validateTomDatoSiste12Mnd.bind(this);
            validateFomDatoNeste12Mnd = validateFomDatoNeste12Mnd.bind(this);
            validateTomDatoNeste12Mnd = validateTomDatoNeste12Mnd.bind(this);
        })
 */
